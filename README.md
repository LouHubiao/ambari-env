...
本来计划于24年12月发布1.0.4版本，但因为更多的精力在国产化系统上尝试，耗费了不少时间与精力。
最终考虑：

- 将两套编译成果分享给大家。
- 1.0.4 暂时未做国产化适配，请给我些时间。

另外大家可以关注我的微信公众号，或加入我的Q群，给我提提意见！感谢

## 下载地址

🎉 **最新`v1.0.4`编译包请扫描公众号免费获取** 🎉
![img.png](.docs/img_18.png)

🎉 **最新`v1.0.3`支持国产化kylin-v10。编译包请扫描公众号免费获取** 🎉

![img.png](.docs/img_19.png)
...
- 适配环境
  ...
  - jdk 1.8
  - python2
  - miniconda py2 系列【部分组建需要不同的java或jdk环境】

- v1.0.5 支持情况

| **组件名称**        | **组件版本** | **env版本** | 时间               |
|-----------------|----------|-----------|------------------|
| Nightingale     | 7.7.2    | 1.0.5     | 2025/01(已支持/测试中) |
| Categraf        | 0.4.1    | 1.0.5     | 2025/01(已支持/测试中) |
| VictoriaMetrics | 1.109.1  | 1.0.5     | 2025/01(已支持/测试中) |
| Celeborn        | 0.5.3    | 1.0.5     | 2025/01(已支持/测试中) |
| Cloudbeaver     | 24.3.3   | 1.0.5     | 2025/01(已支持/测试中) |

- v1.0.4 支持情况

| **组件名称** | **组件版本** | **env版本** | 时间             |
|----------|----------|-----------|----------------|
| Doris    | 2.1.7    | 1.0.4     | 2025/1/13(已支持) |

- v1.0.3 支持情况

| **组件名称**         | **组件版本** | **env版本** | 时间              |
|------------------|----------|-----------|-----------------|
| Phoenix          | 5.1.2    | 1.0.3     | 2024/10/15(已支持) |

...
echo "############## PRE BUILD BIGTOP_1_0_4 start #############"
...
# 定义一个包含所有补丁文件路径的数组
patch_files=(
  "/scripts/build/bigtop/patch1_0_4/patch0-HADOOP-FIXED.diff"
  "/scripts/build/bigtop/patch1_0_4/patch1-BOM-COMPONENT-ADD.diff"
)
...
echo "############## PRE BUILD BIGTOP_1_0_4 end #############" -d

...
# 目标目录和分支版本
declare -A REPOS=(
  ["/opt/modules/ambari"]="branch-2.8.0 https://ghp.ci/https://github.com/apache/ambari.git"
  ["/opt/modules/ambari-metrics"]="master https://ghp.ci/https://github.com/apache/ambari-metrics.git"
